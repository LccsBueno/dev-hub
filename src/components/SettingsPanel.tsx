  ...
  return (
    <div className="max-w-2xl">
      <section className="mb-10">
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  title="Remover"
                  className="flex h-7 w-7 items-center justify-center rounded-md text-muted hover:bg-border hover:text-red-400"
                >
                  <Trash2 size={14} />
                </button>
              </div>
        ...
        <button
          onClick={addFolder}
          className="mt-3 flex items-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-white hover:bg-accent/85"
        >
          <FolderPlus size={16} />
          Adicionar pasta
        </button>
      ...
      <section className="mb-10">
        ...
        <input
          ...
          className="w-64 rounded-lg border border-border bg-card px-3 py-2 font-mono text-sm outline-none focus:border-accent"
        />
      </section>
      ...
      <section>
        ...
        <button
          onClick={onRescan}
          disabled={scanning}
          className="flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-2 text-sm hover:bg-card-hover disabled:opacity-50"
        >
